...
{
  public class TileAttributeMask : ITileAttributeMask
  {
    public bool IsWater(double xPx, double yPx)
    {
      ...
      var b00 = (1 - colFraction) * WaterBit(m_Mask[rowTruncate * 256 + colTruncate]);
      var b01 = colFraction * WaterBit(m_Mask[rowTruncate * 256 + colTruncate + 1]);
      var b10 = (1 - colFraction) * WaterBit(m_Mask[(rowTruncate + 1) * 256 + colTruncate]);
      var b11 = colFraction * WaterBit(m_Mask[(rowTruncate + 1) * 256 + colTruncate + 1]);
      return (1 - rowFraction) * (b00 + b01) + rowFraction * (b10 + b11) > 0.66;
    }

    public TileAttributeMask(byte[] maskData)
    {
      m_Mask = maskData;
    }
    ...
    {
      return (byte)((b >> (byte)AttributeBits.Water) & 1);
    }
